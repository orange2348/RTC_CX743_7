...
#define LAP_MULTI_MEDIA_NAME_FLAG					(1)
#define LAP_MULTI_MEDIA_AUTHER_FLAG					(2)
...
static U16	AV_Dat_RAM[Audio_Name_Length + Audio_Author_Length] = 0;
...
static U8	AV_CarPlay_status = 0;  // 0 : no, 1 : carplay, 2 : android
...
static tTOSTimer PhoneRevsTimer;

static tTOSTimer tToutAudioTimer = 0;
static tTOSTimer tToutPsTimer = 0;
static tTOSTimer tToutPbTimer = 0;
static tTOSTimer tToutNavTimer = 0;
...
static U8  l_u8AVNmaeLengthLast = 0;
static U16 l_Audio_Name_Len_U16 = 0;
static U16 l_Audio_Name_Count_U16 = 0;

static U8  l_u8AVFromLengthLast = 0;
static U16 l_Audio_Author_Len_U16 = 0;
static U16 l_Audio_Author_Count_U16 = 0;
...
#define CanEnterCriticalSection	osSuspendAllInterrupts
#define CanExitCriticalSection osResumeAllInterrupts
...
static void LAP_AVCV_NameHandle(void)
{
	...
	if(l_Audio_Name_Len_U16 > l_Audio_Name_Count_U16)
	{
		AV_Dat_RAM[0+l_Audio_Name_Count_U16*3] = (U16)*(AV_ByteBuff+2)+(((U16)*(AV_ByteBuff+3))<<8&0xFF00);
		AV_Dat_RAM[1+l_Audio_Name_Count_U16*3] = (U16)*(AV_ByteBuff+4)+(((U16)*(AV_ByteBuff+5))<<8&0xFF00);
		AV_Dat_RAM[2+l_Audio_Name_Count_U16*3] = (U16)*(AV_ByteBuff+6)+(((U16)*(AV_ByteBuff+7))<<8&0xFF00);

		l_Audio_Name_Count_U16++;
	}
	else
	{
	...
	else if(AVDataMeg.DataNum==MegDataNum25)
	{
		...
		AV_Dat_RAM[14] = (U16)*(AV_ByteBuff+6)+(((U16)*(AV_ByteBuff+7))<<8&0xFF00);
	}
	else if(AVDataMeg.DataNum==MegDataNum26)
	{
		AV_Dat_RAM[15] = (U16)*(AV_ByteBuff+2)+(((U16)*(AV_ByteBuff+3))<<8&0xFF00);
		AV_Dat_RAM[16] = (U16)*(AV_ByteBuff+4)+(((U16)*(AV_ByteBuff+5))<<8&0xFF00);
		AV_Dat_RAM[17] = (U16)*(AV_ByteBuff+6)+(((U16)*(AV_ByteBuff+7))<<8&0xFF00);
	}
	else if(AVDataMeg.DataNum==MegDataNum27)
	{
		AV_Dat_RAM[18] = (U16)*(AV_ByteBuff+2)+(((U16)*(AV_ByteBuff+3))<<8&0xFF00);
		AV_Dat_RAM[19] = (U16)*(AV_ByteBuff+4)+(((U16)*(AV_ByteBuff+5))<<8&0xFF00);
		AV_Dat_RAM[20] = (U16)*(AV_ByteBuff+6)+(((U16)*(AV_ByteBuff+7))<<8&0xFF00);
	}
	else if(AVDataMeg.DataNum==MegDataNum28)
	{
		AV_Dat_RAM[21] = (U16)*(AV_ByteBuff+2)+(((U16)*(AV_ByteBuff+3))<<8&0xFF00);
		AV_Dat_RAM[22] = (U16)*(AV_ByteBuff+4)+(((U16)*(AV_ByteBuff+5))<<8&0xFF00);
		AV_Dat_RAM[23] = (U16)*(AV_ByteBuff+6)+(((U16)*(AV_ByteBuff+7))<<8&0xFF00);
	}
	else if(AVDataMeg.DataNum==MegDataNum29)
	{
		AV_Dat_RAM[24] = (U16)*(AV_ByteBuff+2)+(((U16)*(AV_ByteBuff+3))<<8&0xFF00);
		AV_Dat_RAM[25] = (U16)*(AV_ByteBuff+4)+(((U16)*(AV_ByteBuff+5))<<8&0xFF00);
		AV_Dat_RAM[26] = (U16)*(AV_ByteBuff+6)+(((U16)*(AV_ByteBuff+7))<<8&0xFF00);
	}
	else if(AVDataMeg.DataNum==MegDataNum2A)
	{
		AV_Dat_RAM[27] = (U16)*(AV_ByteBuff+2)+(((U16)*(AV_ByteBuff+3))<<8&0xFF00);
		AV_Dat_RAM[28] = (U16)*(AV_ByteBuff+4)+(((U16)*(AV_ByteBuff+5))<<8&0xFF00);
		AV_Dat_RAM[29] = (U16)*(AV_ByteBuff+6)+(((U16)*(AV_ByteBuff+7))<<8&0xFF00);
	}
	else if(AVDataMeg.DataNum==MegDataNum2B)
	{
		AV_Dat_RAM[30] = (U16)*(AV_ByteBuff+2)+(((U16)*(AV_ByteBuff+3))<<8&0xFF00);
		AV_Dat_RAM[31] = (U16)*(AV_ByteBuff+4)+(((U16)*(AV_ByteBuff+5))<<8&0xFF00);
		AV_Dat_RAM[32] = (U16)*(AV_ByteBuff+6)+(((U16)*(AV_ByteBuff+7))<<8&0xFF00);
	}
	else if(AVDataMeg.DataNum==MegDataNum2C)
	{
		AV_Dat_RAM[33] = (U16)*(AV_ByteBuff+2)+(((U16)*(AV_ByteBuff+3))<<8&0xFF00);
		AV_Dat_RAM[34] = (U16)*(AV_ByteBuff+4)+(((U16)*(AV_ByteBuff+5))<<8&0xFF00);
		AV_Dat_RAM[35] = (U16)*(AV_ByteBuff+6)+(((U16)*(AV_ByteBuff+7))<<8&0xFF00);
	}
	else if(AVDataMeg.DataNum==MegDataNum2D)
	{
		AV_Dat_RAM[36] = (U16)*(AV_ByteBuff+2)+(((U16)*(AV_ByteBuff+3))<<8&0xFF00);
		AV_Dat_RAM[37] = (U16)*(AV_ByteBuff+4)+(((U16)*(AV_ByteBuff+5))<<8&0xFF00);
		AV_Dat_RAM[38] = (U16)*(AV_ByteBuff+6)+(((U16)*(AV_ByteBuff+7))<<8&0xFF00);
	}
	else if(AVDataMeg.DataNum==MegDataNum2F)
	{
		AV_Dat_RAM[39] = (U16)*(AV_ByteBuff+2)+(((U16)*(AV_ByteBuff+3))<<8&0xFF00);
		AV_Dat_RAM[40] = (U16)*(AV_ByteBuff+4)+(((U16)*(AV_ByteBuff+5))<<8&0xFF00);
		AV_Dat_RAM[41] = (U16)*(AV_ByteBuff+6)+(((U16)*(AV_ByteBuff+7))<<8&0xFF00);
	}
    else
	{	// If the length is over to display on LCD ,we shoule fliter the later data message.
		AVCtrlMeg.DataType = DataType_none;  
...
static void LAP_AVCV_FromHandle(void)
{
	...
	if(l_Audio_Author_Len_U16 > l_Audio_Author_Count_U16)
	{
		AV_Dat_RAM[Audio_Author_Length+0+l_Audio_Author_Count_U16*3] = (U16)*(AV_ByteBuff+2)+(((U16)*(AV_ByteBuff+3))<<8&0xFF00);
		AV_Dat_RAM[Audio_Author_Length+1+l_Audio_Author_Count_U16*3] = (U16)*(AV_ByteBuff+4)+(((U16)*(AV_ByteBuff+5))<<8&0xFF00);
		AV_Dat_RAM[Audio_Author_Length+2+l_Audio_Author_Count_U16*3] = (U16)*(AV_ByteBuff+6)+(((U16)*(AV_ByteBuff+7))<<8&0xFF00);

		l_Audio_Author_Count_U16++;
	}
	else
	{
		// If the length is over to display on LCD ,we shoule fliter the later data message.
	...
	if(AVDataMeg.DataNum==MegDataNum21)
	{
		AV_Dat_RAM[Audio_Author_Length]   = (U16)*(AV_ByteBuff+2)+(((U16)*(AV_ByteBuff+3))<<8&0xFF00);
		AV_Dat_RAM[Audio_Author_Length+1] = (U16)*(AV_ByteBuff+4)+(((U16)*(AV_ByteBuff+5))<<8&0xFF00);
		AV_Dat_RAM[Audio_Author_Length+2] = (U16)*(AV_ByteBuff+6)+(((U16)*(AV_ByteBuff+7))<<8&0xFF00);
	}
	else if(AVDataMeg.DataNum==MegDataNum22)
	{
		AV_Dat_RAM[Audio_Author_Length+3] = (U16)*(AV_ByteBuff+2)+(((U16)*(AV_ByteBuff+3))<<8&0xFF00);
		AV_Dat_RAM[Audio_Author_Length+4] = (U16)*(AV_ByteBuff+4)+(((U16)*(AV_ByteBuff+5))<<8&0xFF00);
		AV_Dat_RAM[Audio_Author_Length+5] = (U16)*(AV_ByteBuff+6)+(((U16)*(AV_ByteBuff+7))<<8&0xFF00);
	}
	else if(AVDataMeg.DataNum==MegDataNum23)
	{
		AV_Dat_RAM[Audio_Author_Length+6] = (U16)*(AV_ByteBuff+2)+(((U16)*(AV_ByteBuff+3))<<8&0xFF00);
		AV_Dat_RAM[Audio_Author_Length+7] = (U16)*(AV_ByteBuff+4)+(((U16)*(AV_ByteBuff+5))<<8&0xFF00);
		AV_Dat_RAM[Audio_Author_Length+8] = (U16)*(AV_ByteBuff+6)+(((U16)*(AV_ByteBuff+7))<<8&0xFF00);
	}
	else if(AVDataMeg.DataNum==MegDataNum24)
	{
		AV_Dat_RAM[Audio_Author_Length+9]  = (U16)*(AV_ByteBuff+2)+(((U16)*(AV_ByteBuff+3))<<8&0xFF00);
		AV_Dat_RAM[Audio_Author_Length+10] = (U16)*(AV_ByteBuff+4)+(((U16)*(AV_ByteBuff+5))<<8&0xFF00);
		AV_Dat_RAM[Audio_Author_Length+11] = (U16)*(AV_ByteBuff+6)+(((U16)*(AV_ByteBuff+7))<<8&0xFF00);
	}
	else if(AVDataMeg.DataNum==MegDataNum25)
	{
		AV_Dat_RAM[Audio_Author_Length+12] = (U16)*(AV_ByteBuff+2)+(((U16)*(AV_ByteBuff+3))<<8&0xFF00);
		AV_Dat_RAM[Audio_Author_Length+13] = (U16)*(AV_ByteBuff+4)+(((U16)*(AV_ByteBuff+5))<<8&0xFF00);
		AV_Dat_RAM[Audio_Author_Length+14] = (U16)*(AV_ByteBuff+6)+(((U16)*(AV_ByteBuff+7))<<8&0xFF00);
	}
	else if(AVDataMeg.DataNum==MegDataNum26)
	{
		AV_Dat_RAM[Audio_Author_Length+15] = (U16)*(AV_ByteBuff+2)+(((U16)*(AV_ByteBuff+3))<<8&0xFF00);
		AV_Dat_RAM[Audio_Author_Length+16] = (U16)*(AV_ByteBuff+4)+(((U16)*(AV_ByteBuff+5))<<8&0xFF00);
		AV_Dat_RAM[Audio_Author_Length+17] = (U16)*(AV_ByteBuff+6)+(((U16)*(AV_ByteBuff+7))<<8&0xFF00);
	}
	else if(AVDataMeg.DataNum==MegDataNum27)
	{
		AV_Dat_RAM[Audio_Author_Length+18] = (U16)*(AV_ByteBuff+2)+(((U16)*(AV_ByteBuff+3))<<8&0xFF00);
		AV_Dat_RAM[Audio_Author_Length+19] = (U16)*(AV_ByteBuff+4)+(((U16)*(AV_ByteBuff+5))<<8&0xFF00);
		AV_Dat_RAM[Audio_Author_Length+20] = (U16)*(AV_ByteBuff+6)+(((U16)*(AV_ByteBuff+7))<<8&0xFF00);
	}
	else if(AVDataMeg.DataNum==MegDataNum28)
	{
		AV_Dat_RAM[Audio_Author_Length+21] = (U16)*(AV_ByteBuff+2)+(((U16)*(AV_ByteBuff+3))<<8&0xFF00);
		AV_Dat_RAM[Audio_Author_Length+20] = (U16)*(AV_ByteBuff+4)+(((U16)*(AV_ByteBuff+5))<<8&0xFF00);
		AV_Dat_RAM[Audio_Author_Length+23] = (U16)*(AV_ByteBuff+6)+(((U16)*(AV_ByteBuff+7))<<8&0xFF00);
	}
	else if(AVDataMeg.DataNum==MegDataNum29)
	{
		AV_Dat_RAM[Audio_Author_Length+24] = (U16)*(AV_ByteBuff+2)+(((U16)*(AV_ByteBuff+3))<<8&0xFF00);
		AV_Dat_RAM[Audio_Author_Length+25] = (U16)*(AV_ByteBuff+4)+(((U16)*(AV_ByteBuff+5))<<8&0xFF00);
		AV_Dat_RAM[Audio_Author_Length+26] = (U16)*(AV_ByteBuff+6)+(((U16)*(AV_ByteBuff+7))<<8&0xFF00);
	}
	else if(AVDataMeg.DataNum==MegDataNum2A)
	{
		AV_Dat_RAM[Audio_Author_Length+27] = (U16)*(AV_ByteBuff+2)+(((U16)*(AV_ByteBuff+3))<<8&0xFF00);
		AV_Dat_RAM[Audio_Author_Length+28] = (U16)*(AV_ByteBuff+4)+(((U16)*(AV_ByteBuff+5))<<8&0xFF00);
		AV_Dat_RAM[Audio_Author_Length+29] = (U16)*(AV_ByteBuff+6)+(((U16)*(AV_ByteBuff+7))<<8&0xFF00);
	}
	else if(AVDataMeg.DataNum==MegDataNum2B)
	{
		AV_Dat_RAM[Audio_Author_Length+30] = (U16)*(AV_ByteBuff+2)+(((U16)*(AV_ByteBuff+3))<<8&0xFF00);
		AV_Dat_RAM[Audio_Author_Length+31] = (U16)*(AV_ByteBuff+4)+(((U16)*(AV_ByteBuff+5))<<8&0xFF00);
		AV_Dat_RAM[Audio_Author_Length+32] = (U16)*(AV_ByteBuff+6)+(((U16)*(AV_ByteBuff+7))<<8&0xFF00);
	}
	else if(AVDataMeg.DataNum==MegDataNum2C)
	{
		AV_Dat_RAM[Audio_Author_Length+33] = (U16)*(AV_ByteBuff+2)+(((U16)*(AV_ByteBuff+3))<<8&0xFF00);
		AV_Dat_RAM[Audio_Author_Length+34] = (U16)*(AV_ByteBuff+4)+(((U16)*(AV_ByteBuff+5))<<8&0xFF00);
		AV_Dat_RAM[Audio_Author_Length+35] = (U16)*(AV_ByteBuff+6)+(((U16)*(AV_ByteBuff+7))<<8&0xFF00);
	}
	else if(AVDataMeg.DataNum==MegDataNum2D)
	{
		AV_Dat_RAM[Audio_Author_Length+36] = (U16)*(AV_ByteBuff+2)+(((U16)*(AV_ByteBuff+3))<<8&0xFF00);
		AV_Dat_RAM[Audio_Author_Length+37] = (U16)*(AV_ByteBuff+4)+(((U16)*(AV_ByteBuff+5))<<8&0xFF00);
		AV_Dat_RAM[Audio_Author_Length+38] = (U16)*(AV_ByteBuff+6)+(((U16)*(AV_ByteBuff+7))<<8&0xFF00);
	}
	else if(AVDataMeg.DataNum==MegDataNum2F)
	{
		AV_Dat_RAM[Audio_Author_Length+39] = (U16)*(AV_ByteBuff+2)+(((U16)*(AV_ByteBuff+3))<<8&0xFF00);
		AV_Dat_RAM[Audio_Author_Length+40] = (U16)*(AV_ByteBuff+4)+(((U16)*(AV_ByteBuff+5))<<8&0xFF00);
		AV_Dat_RAM[Audio_Author_Length+41] = (U16)*(AV_ByteBuff+6)+(((U16)*(AV_ByteBuff+7))<<8&0xFF00);
	}
	else
	{
		AVCtrlMeg.DataType = DataType_none;
...
static void LAP_PhoneBook_DatMegRead(U8 u8Sor, U8 u8ID, U8 u8NumOrder, U8 u8NamOrder)
{
	...
	{		
		...
		for(u8s=(u8m/2); u8s<8; u8s++) //clear the unused data
		{
			*(PB_Dat_RAM+(u8i-1)*64+(u8j-1)*8+u8s) = 0;
		}
	}
	else  //Store the contact's data in RAM.
	{
		if(u8i!=0)
		{
			...
			for(u8s=u8k; u8s<8; u8s++) //clear the unused data
			{
				*(PB_Dat_RAM+(u8i-1)*64+(u8j-1)*8+u8s) = 0;
			}
		}
	...
	if(u8i==1)
	{
		...
		for(u8n=u8k; u8n<8; u8n++) //clear the unused data
		{
			*(NumList_RAM+192+(u8j-1)*8+u8n) = 0;
		}
	}
	else if(u8i==2)
	{
		...
		if(((*AV_ByteBuff>=0x80) && (*(AV_ByteBuff+1) != 0)) || ((*AV_ByteBuff>0x80)))  //control meg receive
		{
			...
			if(AVCtrlMeg.DataLength>3)
			{
				...
				if(AVCtrlMeg.DataType==DataType_Name)
				{
					...
					if(u8AVNmaeLength>Audio_Name_Length)
					{
						u8AVNmaeLength = Audio_Name_Length;
					}
					else
					{
						//invalid length
					...
					l_Audio_Name_Len_U16 = u8AVNmaeLength/3;
					if (0 != u8AVNmaeLength%3)
					{
						l_Audio_Name_Len_U16++;
					}

					l_Audio_Name_Count_U16 = 0;
					
					#else
					if ((CfgDate_Value_1 <= LAP_AVCV_AudioSourceValidProcess()) && (SOU_MULTI_SOURCE_ANDROID_AUTO == AV_Source))
					{
						if(u8AVNmaeLength>Audio_Name_Length)
						{
							u8AVNmaeLength = Audio_Name_Length;
				...
				else if(AVCtrlMeg.DataType==DataType_Author)
				{
					...
					#if 1
					if(u8AVFromLength>Audio_Author_Length)
					{
						u8AVFromLength = Audio_Author_Length;
					}
					else
					{
						//invalid length
					...
					l_Audio_Author_Len_U16 = u8AVFromLength/3;
					if (0 != u8AVFromLength%3)
					{
						l_Audio_Author_Len_U16++;
					}

					l_Audio_Author_Count_U16 = 0;
				...
				else if(AVCtrlMeg.DataType==DataType_RadioInfo)
				{
					...
					if(u8AVRadioLength>Audio_RadioInfo_Length)
					{
						u8AVRadioLength = Audio_RadioInfo_Length;
					}
					else
					{
						//invalid length
                ...
                else if(AVCtrlMeg.DataType==DataType_Duration)
				{
					...
					if(u8AVDurationLength>Audio_Duration_Length)
					{
						u8AVDurationLength = Audio_Duration_Length;
					}
					else
					{
						//invalid length
                ...
                else if(AVCtrlMeg.DataType==DataType_PlayTime)
				{
					...
					if(u8AVPlayTimeLength>Audio_PlayTime_Length)
					{
						u8AVPlayTimeLength = Audio_PlayTime_Length;
					}
					else
					{
						//invalid length
...
void LAP_AudioVideo_TransmitProcess(void)
{
	...
	if (u8IgnOffAnimRunFlag == 0)
	{
		if (CfgDate_Value_1 <= LAP_AVCV_AudioSourceValidProcess())
		{
			sAVCV_IPCL.AVCV_CarOrAndStatus = AV_CarPlay_status;
	...
	{
		/* ign off animation running */
	}

	if ((l_Audio_Name_Len_U16 <= l_Audio_Name_Count_U16) && (0 != memcmp(&AV_Dat_RAM[0] , &sAVCV_IPCL.AVCV_Audio_Char[0] , u8AVNmaeLength) || (l_u8AVNmaeLengthLast != u8AVNmaeLength))) // Accept to complete
	{
		// name
		...
		for(u8AVCount=u8AVNmaeLength; u8AVCount<Audio_Name_Length; u8AVCount++) /*Clear unused data buffer which waiting to be sent.*/
		{
			sAVCV_IPCL.AVCV_Audio_Char[u8AVCount] = 0;
		}

		sAVCV_IPCL.AVCV_Audio_NameLength = u8AVNmaeLength;
		l_u8AVNmaeLengthLast = u8AVNmaeLength;
		multi_media_Android_Text_Offset_Count_Reset(LAP_MULTI_MEDIA_NAME_FLAG);
	}
	else
	{
		/* Receiving data */
	...
	if ((l_Audio_Author_Len_U16 <= l_Audio_Author_Count_U16) && ((0 != memcmp(&AV_Dat_RAM[Audio_Name_Length] , &sAVCV_IPCL.AVCV_Audio_Char[Audio_Name_Length] , u8AVFromLength)) || (l_u8AVFromLengthLast != u8AVFromLength))) // Accept to complete
	{
		// author
		for (u8AVCount=0; u8AVCount<u8AVFromLength; u8AVCount++) /*Transfer phone number data to buffer to wait to be sent.*/
		{
			sAVCV_IPCL.AVCV_Audio_Char[Audio_Name_Length+u8AVCount] = *(AV_Dat_RAM+Audio_Name_Length+u8AVCount);
		}

		for(u8AVCount=u8AVFromLength; u8AVCount<Audio_Author_Length; u8AVCount++) /*Clear unused data buffer which waiting to be sent.*/
		{
			sAVCV_IPCL.AVCV_Audio_Char[Audio_Name_Length+u8AVCount] = 0;
		}

		sAVCV_IPCL.AVCV_Audio_AuthorLength = u8AVFromLength;
		l_u8AVFromLengthLast = u8AVFromLength;
		multi_media_Android_Text_Offset_Count_Reset(LAP_MULTI_MEDIA_AUTHER_FLAG);
	}
	else
	{
		/* Receiving data */
	...
	{
		sAVCV_IPCL.AVCV_Audio_Char[Audio_Name_Length+Audio_Author_Length+u8AVCount] = (U16)(*(AV_Radio_RAM+u8AVCount));
	}
	
	for(u8AVCount=u8AVRadioLength; u8AVCount<Audio_RadioInfo_Length; u8AVCount++)	/*filter the invalid data in arrary*/
	{
		sAVCV_IPCL.AVCV_Audio_Char[Audio_Name_Length+Audio_Author_Length+u8AVCount] = 0;		
	}

    // duration
    for (u8AVCount = 0; u8AVCount < u8AVDurationLength; u8AVCount++)
	{
		sAVCV_IPCL.AVCV_Audio_Char[Audio_Name_Length+Audio_Author_Length+Audio_RadioInfo_Length+u8AVCount] = AV_Duration_RAM[u8AVCount];
	}

	for(u8AVCount=u8AVDurationLength; u8AVCount<Audio_Duration_Length; u8AVCount++)	/*filter the invalid data in arrary*/
	{
		sAVCV_IPCL.AVCV_Audio_Char[Audio_Name_Length+Audio_Author_Length+Audio_RadioInfo_Length+u8AVCount] = 0;
	}

	if ((6 == u8AVDurationLength) || (7 == u8AVDurationLength))
	{
		sAVCV_IPCL.AVCV_Audio_Char[Audio_Name_Length+Audio_Author_Length+Audio_RadioInfo_Length+u8AVDurationLength-1] = 0;
	}
	else
	{
		/* NOP */
	...
	{
		sAVCV_IPCL.AVCV_Audio_Char[Audio_Name_Length+Audio_Author_Length+Audio_RadioInfo_Length+Audio_Duration_Length+u8AVCount] = AV_PlayTime_RAM[u8AVCount];
	}

	for(u8AVCount=u8AVPlayTimeLength; u8AVCount<8; u8AVCount++)	/*filter the invalid data in arrary*/
	{
		sAVCV_IPCL.AVCV_Audio_Char[Audio_Name_Length+Audio_Author_Length+Audio_RadioInfo_Length+Audio_Duration_Length+u8AVCount] = 0;
	}

	if ((6 == u8AVPlayTimeLength) || (7 == u8AVPlayTimeLength))
	{
		sAVCV_IPCL.AVCV_Audio_Char[Audio_Name_Length+Audio_Author_Length+Audio_RadioInfo_Length+Audio_Duration_Length+u8AVPlayTimeLength-1] = 0;
	}
	else
	{
		/* NOP */
...
void LAP_AVCV_PSTransmitProcess(void)
{
	...
	// number
	for(u8PSCount=0; u8PSCount<u8PSNumbLength; u8PSCount++)
	{
		sAVCV_IPCL.AVCV_Ps_Char[16+u8PSCount] = PS_Numb_RAM[u8PSCount];
	}	

	for(u8PSCount=u8PSNumbLength; u8PSCount<16; u8PSCount++)
	{
...
{	
    ...
    //Timeout 
	if((TOSIsTimerStarted((&tToutPbTimer))) && (TOSIsTimerElapsed((&tToutPbTimer),mTOSConvMsInTimerTick(3000))))
	{
        u8PhoneBookUpdate = 0;
    
		TOSStopTimer((&tToutPbTimer));
		return;
	}
	...
	if(DATCplTableTramesPresentes_AVCV[PHONEBOOK] == 1 || U8PbLenErrFlg == 1)
	{
		...
		*(PB_ByteBuff+7) = MP5_PhoneNum_TX_0x383_Byte_8;
		...
		if(*PB_ByteBuff>0x80)  //control message receive
		{
			...
			if(PBCtrlMeg.DataSource==1 && (PBCtrlMeg.ContactsID==1 || PBCtrlMeg.ContactsID==0))
			{
				u8PhoneBookUpdate++;
			}
			else
			...
			if(PBCtrlMeg.DataLength>AVCVPBMegNoData)
			{
                ...
                TOSStartTimer((&tToutPbTimer));
			}
			else if (AVCVPBMegNoData == PBCtrlMeg.DataLength && 0 == PBCtrlMeg.ContactsID) // no telephone book info
			{
				TOSStartTimer((&tToutPbTimer));
			}
			else
...
void LAP_PhoneBook_TransmitProcess(void)
{
    ...
    if (u8PhoneBookUpdate != 0) // phone book updating
    {
        return ;
    }
    else 
    {
        //ivi send phone book info finished
    }
...
{	
    ...
    if ((u8NaviEndFlg == 0) && (u8Msg384ToutFlg == 0 && (sMP5Navi_IPCL.Navi_Sign > 0 && sMP5Navi_IPCL.Navi_Sign < 0x52)))
    {
...
/*==============================================================================
*  FUNCTION NAME : void LAP_AVCV_CarPlayOrAndoidProcess(void)
* 
*  PARAMETERS:   
*
*  RETURN VALUE :   
* 
*  DESIGN INFORMATION : The process of select carplay or andriod.
*===============================================================================*/
void LAP_AVCV_CarPlayOrAndoidProcess(void)
{
	U8 u8_0x382_MsgNR		= 0;
	U8 u8_0x382_msgTout		= 0;
	U8 u8_MP5_PhoConSts_sig = 0;

	Rte_Read_rpSR_CANMSG_GW_MP5_0x382_ComIn_NR(&u8_0x382_MsgNR);
	Rte_Read_rpSR_CANMSG_GW_MP5_0x382_ComIn_Tout(&u8_0x382_msgTout);

	if ((RTE_E_NEVER_RECEIVED == u8_0x382_MsgNR) || (RTE_E_TIMEOUT == u8_0x382_msgTout))
	{
		u8_MP5_PhoConSts_sig = 0;
	}
	else
	{
		Rte_Read_rpSR_CANMSG_GW_MP5_0x382_ComIn_MP5_PhoneConnectSts(&u8_MP5_PhoConSts_sig);
	}

	AV_CarPlay_status = u8_MP5_PhoConSts_sig;
}

/*==============================================================================
*  FUNCTION NAME : void LAP_AVCV_AudioSourceValidProcess(void)
* 
*  PARAMETERS:   
*
*  RETURN VALUE :   
...
*  DESIGN INFORMATION : The process of select carplay or andriod.
*===============================================================================*/
U8 LAP_AVCV_AudioSourceValidProcess(void)
{
	U8 fl_Audio_Source_u8 = CfgDate_Value_0;

#if (LAP_MULTI_MEDIA_VEHICLE_CONFIG_ENG == LAP_MULTI_MEDIA_VEHICLE_CONFIG_FLAG)

	if (((SOU_MULTI_SOURCE_INTERNET_RADIO != AV_Source)
	&& (SOU_MULTI_SOURCE_ONLINE_MUSIC != AV_Source)
	&& (SOU_MULTI_SOURCE_NETWORK_PROGRAM != AV_Source)) && (SOU_MULTI_SOURCE_MAX > AV_Source))
	{
		fl_Audio_Source_u8 = CfgDate_Value_1;
	}

#else

	if (((SOU_MULTI_SOURCE_IPOD != AV_Source) 
	&& (SOU_MULTI_SOURCE_CARPLAY != AV_Source) 
	&& (SOU_MULTI_SOURCE_ANDROID_AUTO != AV_Source) 
	&& (SOU_MULTI_SOURCE_DAB != AV_Source)) && (SOU_MULTI_SOURCE_MAX > AV_Source))
	{
		fl_Audio_Source_u8 = CfgDate_Value_1;
	}
...
void LAP_AVCV_ReverseOperationProcess(void)
{
	...
	if(bKeyActived==1)
	{
		...
		else if((u8Command >= Cmd_USB)&&(u8Command <= Cmd_DAB))
		{
...
void LAP_AVCV_ReverseCallUpProcess(void)
{
	...
	if(eCmd_Call_H && eCmd_Call_L)
	{
		...
		TOSStartTimer(&PhoneRevsTimer);
		DATACOM_WriteU8BitClustCallUpDefault(cFalse);
		u8FrameCycle = 0;
	}

	if(TOSIsTimerStarted(&PhoneRevsTimer) && TOSIsTimerElapsed((&PhoneRevsTimer),mTOSConvMsInTimerTick(TIME_INTERVAL)))
	{
		if(u8FrameCycle>=2)
		{
			u8FrameCycle = 0;
			DATACOM_WriteU8BitClustCallUpDefault(cFalse);
			TOSStopTimer(&PhoneRevsTimer);
		}
		else
		{
			u8FrameCycle++;
...
{	
	...
	LAP_AVCV_CarPlayOrAndoidProcess();
}
