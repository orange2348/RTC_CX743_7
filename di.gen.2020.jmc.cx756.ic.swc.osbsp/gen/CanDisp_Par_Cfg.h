...
#define CanDisp_Number_Of_Rx_Messages        53u /*ch0 and ch1 total*/
#define CanDisp_Number_Of_Rx_MBs             53u /*finally not used*/
#define CanDisp_Number_Of_Tx_MBs             15u /*finally not used*/
#define CanDisp_Number_Of_MBs                68u /*ch0 and ch1 total*/
#define CanDisp_Number_Of_Tx_Messages        15u /*ch0 and ch1 total*/
#define CanDisp_Number_Of_Tx_Messages_Ch0    9u /*ch0 tx total*/
#define CanDisp_Number_Of_Tx_Messages_Ch1    6u /*ch1 tx total*/
