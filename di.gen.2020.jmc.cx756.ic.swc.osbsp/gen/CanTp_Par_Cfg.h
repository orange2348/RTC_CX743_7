...
#define CanTp_Ch0_Start_RespID_Handle          						7u	//MCAL Transmit HTH_IC_DiagResp index value, for tp_par_cfg
#define Can_Ch0_Tp_Tx_Msg_IC_DiagResp_TMH							7u	//MCAL Transmit HTH_IC_DiagResp index value, for dcm

/*   TP RX MESSAGE PDU MACRO  DEFINITIONS */ 

#define Can_Ch0_Tp_Rx_Msg_Tester_DiagReqToIC                       44u	//MCAL Receive HRH_Tester_DiagReqToIC index value, for disp_par_cfg
#define Can_Ch0_Tp_Rx_Msg_Tester_DiagFuncReq                       45u	//MCAL Receive HRH_Tester_DiagFuncReq index value, for disp_par_cfg

#define CanTp_Ch0_Start_ReqID_Handle         44u		//the smaller HRH of Diagnostic Physical and Functional request, for tp_par_cfg
#define CanTp_Ch0_Stop_ReqID_Handle          45u		//the larger HRH of Diagnostic Physical and Functional request, for tp_par_cfg
