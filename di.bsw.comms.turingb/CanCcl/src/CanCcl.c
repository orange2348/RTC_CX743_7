...
static Ccl_StatusType CclStatus = CCL_UNINIT;
...
void Ccl_RxIndication(PduIdType RxPduId)
{
    ...
    CAN_UINT8 NumOfMsgSignals = 0;

    CAN_UINT16 SignalHandleStart = 0;

    CAN_UINT16 CanSignalIndex = 0;

    CAN_UINT16 RxAckSignalIndex = 0;
...
void Ccl_RxToutIndication(PduIdType RxPduId)
{
    ...
    CAN_UINT16 RxTOutSignalIndex = 0;
